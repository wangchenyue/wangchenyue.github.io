...
function positionTile(tile, elm) {
  ...
  elm.style.top = y * 200 + 'px';
  elm.style.left = x * 200 + 'px';
}
...
document.querySelector('.game').addEventListener('touchstart', handleTouchStart, false);
document.querySelector('.game').addEventListener('touchmove', handleTouchMove, false);
